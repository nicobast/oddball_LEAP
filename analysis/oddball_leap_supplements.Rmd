...
For the dynamic BPS model, medication had a significant effect on the cubic fit of BPS (F(1, 294641) = 15.52, p < .001) and was described by a higher BPS for medication (0.03 [0.01, 0.04]). However, this covariate effect did not alter the group differences in dynamic BPS (F(3, 298714) = 12.53, p < .001).
