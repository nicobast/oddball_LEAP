...
-   [supplement 11 - BPS linear mixed model][supplement 11]
-   [supplement 12 - SEPR linear mixed model][supplement 12]
-   [supplement 13 - MMN linear mixed model][supplement 13]
-   [supplement 14 - Bayesian posterior estimate MCMC chain convergence][supplement 14]
...
```{r Bayesian posterior estimate chain convergence}
